        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PokemonCategoryCategoryId = table.Column<int>(type: "integer", nullable: true),
                    PokemonCategoryPokemonId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PokemonCategories_PokemonCategories_PokemonCategoryPokemonI~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PokemonOwnerOwnerId = table.Column<int>(type: "integer", nullable: true),
                    PokemonOwnerPokemonId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PokemonOwners_PokemonOwners_PokemonOwnerPokemonId_PokemonOw~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PokemonCategories_PokemonCategoryPokemonId_PokemonCategoryC~",
                table: "PokemonCategories",
